...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "yes") then
		...
		if npcHandler:getTopic(playerId) == 1 then
			...
			npcHandler:say({ "Excellent! Now, let me explain. If you donate 25.000.000.000 gold pieces, you will be entitled to wear a unique outfit. ...", "You will be entitled to wear the {armor} for 15.000.000.000 gold pieces, {helmet} for an additional 5.000.000.000 and the {boots} for another 5.000.000.000 gold pieces. ...", "What will it be?" }, npc, creature)
		...
		elseif npcHandler:getTopic(playerId) == 3 then -- ARMOR/OUTFIT
			if player:getStorageValue(Storage.OutfitQuest.GoldenOutfit) < 1 then
				if player:getMoney() + player:getBankBalance() >= 15000000000 then
					...
					if inbox and #inboxItems <= inbox:getMaxCapacity() then
						...
						player:removeMoneyBank(15000000000)
	...
	elseif (MsgContains(message, "armor")) and npcHandler:getTopic(playerId) == 2 then
		npcHandler:say("So you wold like to donate 15.000.000.000 gold pieces which in return will entitle you to wear a unique armor?", npc, creature)
	...
	elseif (MsgContains(message, "helmet")) and npcHandler:getTopic(playerId) == 2 then
		npcHandler:say("So you would like to donate 5.000.000.000 gold pieces which in return will entitle you to wear unique helmet?", npc, creature)
	...
	elseif (MsgContains(message, "boots")) and npcHandler:getTopic(playerId) == 2 then
		npcHandler:say("So you would like to donate 5.000.000.000 gold pieces which in return will entitle you to wear a unique boots?", npc, creature)
