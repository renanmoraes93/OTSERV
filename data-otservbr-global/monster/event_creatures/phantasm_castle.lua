local mType = Game.createMonsterType("Phantasm Castle")
local monster = {}
...
monster.summon = {
	maxSummons = 6,
	summons = {
		{name = "Phantasm Summon", chance = 20, interval = 2000, count = 6}
	}
}
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -875},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -250, maxDamage = -810, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = false},
	...
	{name ="phantasm drown", interval = 2000, chance = 25, target = false},
	{name ="drunk", interval = 2000, chance = 25, radius = 5, effect = CONST_ME_MAGIC_RED, target = false, duration = 6000}
}
