local mType = Game.createMonsterType("Dark Torturer Castle")
local monster = {}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -981, range = 7, shootEffect = CONST_ANI_THROWINGKNIFE, target = false},
	{name ="dark torturer skill reducer", interval = 2000, chance = 15, target = false}
}
