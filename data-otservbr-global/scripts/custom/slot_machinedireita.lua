...
local machinesConfig = {
	[9997] = {
		...
		pisosPorMachine = 5,
		posicaoDoCentro1 = Position(32245, 32201, 6),
		posicaoDoCentro2 = Position(32246, 32201, 6),
		posicaoDoCentro3 = Position(32247, 32201, 6),
		items = {
...
local globalevent = GlobalEvent("SlotMachine2")
