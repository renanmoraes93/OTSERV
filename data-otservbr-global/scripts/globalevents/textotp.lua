local config = {
    interval = 3000,
    texts = {
        { pos = Position(31321, 32380, 7), text = "Clean Shop Bags", effects = { CONST_ME_TELEPORT, CONST_ME_DRAWBLOOD } },
        { pos = Position(31329, 32386, 7), text = "Clean Shop Bags", effects = { CONST_ME_TELEPORT, CONST_ME_DRAWBLOOD } },
       ...
       { pos = Position(31611, 32585, 7), text = "Top 1", effects = { CONST_ME_DRAWBLOOD } },
       { pos = Position(31609, 32584, 7), text = "Top 2", effects = { CONST_ME_DRAWBLOOD } },
       { pos = Position(31613, 32584, 7), text = "Top 3", effects = { CONST_ME_DRAWBLOOD } },
