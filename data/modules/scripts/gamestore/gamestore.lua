...
HomeBanners = {
	images = { "home/banner_evolution_home_store.png" },
	delay = 10,
}
...
GameStore.Categories = {
  ...
  --[[
      ...
      --[[
			{
				...
				count = 1,
				movable = true,
				description = "Regenera vida e mana quando usado.",
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
      {
				...
				price = 1250,
				id = 223,
				description = "{character}\n{speedboost}\n\n<i>The is a beauty Gorgon Hydra Mount!</i>",
			...
			},
      {
				...
				price = 750,
				id = 126,
				description = "{character}\n{speedboost}\n\n<i>The is a beauty Fleeting Knowledge Mount! Fly through the knowled of the elder tibians.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Armoured_War_Horse.png" },
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		offers = {
      {
				icons = { "Outfit_Arbalester_Male_Addon_3.png" },
				name = "Golden Outfit",
				home = true,
				price = 2500,
			...
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Jouster is all geared up for a Itens Custom, ready to partake in festive activities involving friendly competition to prove their chivalry. However, being well-armoured, they are also a force to be reckoned with on the battlefield, especially with a trusty steed at their service.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
	...
	-- House ~ Decorations
	{
		...
		offers = {
			{
				icons = { "Alchemistic_Bookstand.png" },
				name = "Cheest of Elder's",
				price = 100,
				itemtype = 44893,
				count = 1,
				description = "Bau de house para Druids com 40 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				name = "Cheest of Elite's",
				price = 100,
				itemtype = 44895,
				count = 1,
				description = "Bau de house para Knights com 40 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				name = "Cheest of Master's",
				price = 100,
				itemtype = 44897,
				count = 1,
				description = "Bau de house para Sorcerer com 40 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Zaoan_Wall_Lamps.png" },
				name = "Cheest of Royal's",
				price = 100,
				itemtype = 44898,
				count = 1,
				description = "Bau de house para Paladins com 40 slots",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
		},
	},
	...
	-- House ~ Upgrades
	{
		...
		offers = {
			...
			{
				icons = { "none.png" },
				name = "Ancient Ferrumbras Exercise Dummy",
				price = 1500,
				itemtype = 45205,
				home = true,
				count = 1,
			...
			{
				icons = { "none.png" },
				name = "Ferrumbras Full Exercise Dummy",
				price = 1500,
				itemtype = 45209,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
			...
			{
				icons = { "none.png" },
				name = "Ceremonial Exercise Dummy",
				price = 1500,
				itemtype = 45212,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
			...
			},
			{
				...
				itemtype = 44842,
				count = 1,
				description = "<i>Open forge in your house!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Mailbox.png" },
	...
	-- Extras ~ Extras Services
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 22118,
				movable = true,
				description = "<i>Turns your tibia coins into a physical item making possible to trade with other players",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Sex_Change.png" },
	...
	-- Itens Custom ~ Exclusive Offers
	{
      ...
      --[[
			...
			{
				icons = { "Sublime_Itens Custom_Accolade.png" },
				name = "Sublime Itens Custom Accolade",
				price = 250,
				itemtype = 31472,
				movable = true,
				count = 1,
			...
			{
				icons = { "Sublime_Itens Custom_Carpet.png" },
				name = "Sublime Itens Custom Carpet",
				price = 100,
				itemtype = 31467,
				movable = true,
				count = 1,
			...
			{
				icons = { "Itens Custom_Accolade.png" },
				name = "Itens Custom Accolade",
				price = 250,
				itemtype = 31470,
				movable = true,
				count = 1,
			...
			{
				icons = { "Itens Custom_Carpet.png" },
				name = "Itens Custom Carpet",
				price = 100,
				itemtype = 31466,
				movable = true,
				count = 1,
        ...
        offers = { 
             {
			   ...
			   movable = true,
               count = 1,
               description = "This is a golden blessed shield. This item is an artifact of extreme wealth. \n\n ",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             },
             {
               icons = { "none.png" },
			   ...
			   movable = true,
               count = 1,
               description = "This is a golden crown. This item is a crown of the extreme wealth kings.",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             },		  
             {
               icons = { "none.png" },
			   ...
			   movable = true,
               count = 1,
               description = "This is a golden horned helmet. This item is an artifact of extreme wealth.",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             }, 
             {
              icons = { "none.png" },
			  ...
			  movable = true,
              count = 1,
              description = "This is a golden longsword. This item is an artifact of extreme wealth.",
              type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            {
      				icons = { "Gilded_Warlord_Sword.png" },
      				...
      				movable = true,
      				count = 1,
      				description = "This is an Golden Warlord Sword. This item is an artifact of extreme wealth.",
      				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
      			},
            {
              icons = { "none.png" },
            ...
            },
			{
			   ...
			   movable = true,
               count = 1,
               description = "This is a Shield of Destiny. This item is an artifact of extreme wealth.",
               type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
             },
    ...
    --[[

		{
                ...
                count = 1,
		movable = true,
                description = "Use e ganhe um item random weapons club ou shield",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
		...
		movable = true,
			  ...
			  {
                icons = { "none.png" },
                name = "NPC Hunt Refiller",
                price = 2500,
                itemtype = 44912,
                count = 1,
                description = "Usando esse item voce tera um NPC EXCLUSIVO por 100 segundos, onde podera obter desconto em 10% em todos items de refill como potions, runas, exercises, arrows, bolts, pode ser usado de 45m em 45m e SEM BATLLE. E Somente podera ser usado pelo jogador de adquiriu.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
       --[[
			  {
                ...
                count = 1,
		movable = true,
                description = "Usando esse item voce podera escolher uma mount do jogo. !mountsdoll",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
        
			  {
                ...
                count = 1,
		movable = true,
                description = "Usando esse item voce podera escolher um addon do jogo. !addondoll",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
        ]]
			  {
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce podera abrir a  exalted forge em qualquer lugar do jogo.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              --[[
		{
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce podera ser teletransportado para sua cidade natal, lembrando que voce nao pode estar com o battle ativo.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Usando esse item voce ganhara o maximo de dusts para forge.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              
			  {
                icons = { "none.png" },
                name = "Mimic Equipament",
                price = 250,
                itemtype = 45095,
                count = 1,
				movable = true,
                description = "Usando esse item voce ganhara um nivel de tier no item desejado.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
              ]]
			  {
                ...
                count = 1,
				movable = true,
                description = "Com esse item voce podera tentar a sorte em nosso sistema de slot cassino.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
              },
			  {
                icons = { "none.png" },
			...
			},
      {
          ...
          count = 1,
	movable = false,
          description = "Use this item to sell loot inside the cave instantly. You need a loot pouch to use this item.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
      },	
			  {
                icons = { "none.png" },
                ...
                count = 5,
				movable = true,
                description = "Com esse item voce podera tentar a sorte em nosso sistema de roullete 5x.",
                type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
              },		  
               },
           },
 ...
 {     
     ...
     offers = {
			{
                icons = { "none.png" },
                name = "Evolution Backpack",
		home = true,
                price = 750,
                itemtype = 45245,
                count = 1,
				movable = true,
                description = "-> Evolution Backpack (vol36). Regen 100mp/100hp each 2secs",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            --[[
			{
                icons = { "none.png" },
                name = "Evolution Boots",
                price = 250,
                itemtype = 45153,
                count = 1,
				movable = true,
                description = "-> Evolution Boots. Regen 100mp/100hp each 2secs",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            ]]
			{
                icons = { "none.png" },
                name = "Chalice of Evolution",
		            home = true,
                price = 750,
                itemtype = 45204,
                count = 1,
				movable = true,
                description = "-> Chalice of Evolution. (critical hit chance 10%, critical extra damage +13%, life leech amount +24%, mana leech amount +17%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },	
            {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Use this key to open a Exclusive Cave for 24 Hours. By the time you use this key, the GODS will bless you with more 24 hours of stamina.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },		
            {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Use this key to open a Exclusive Cave for 12 Hour. By the time you use this key, the GODS will bless you with more 12 hours of stamina.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },		
            {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Use this key to open a Exclusive Cave for 6 Hour. By the time you use this key, the GODS will bless you with more 6 hours of stamina.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },	
            {
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "Use this key to open a Exclusive Cave for 1 Hour.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },	
            
			--[[{
                icons = { "none.png" },
                name = "Cristaline Backpack",
		home = true,
                price = 50,
                itemtype = 44792,
                count = 1,
				movable = true,
                description = "-> Cristaline Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
			...
			{
                icons = { "none.png" },
                name = "Fire 'n ice Backpack",
                price = 50,
                itemtype = 45052,
                count = 1,
				movable = true,
                description = "-> Fire 'n ice Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Roullete Backpack",
                price = 50,
                itemtype = 45080,
                count = 1,
				movable = true,
                description = "-> Roullete Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Modukot Backpack",
                price = 50,
                itemtype = 45081,
                count = 1,
				movable = true,
                description = "-> Modukot Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Eternal Night Demon Backpack",
                price = 50,
                itemtype = 45109,
                count = 1,
				movable = true,
                description = "-> Eternal Night Demon Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Eternal Night Shadow Backpack",
                price = 50,
                itemtype = 45121,
                count = 1,
				movable = true,
                description = "-> Eternal Night Shadow Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Eternal Night Moon Backpack",
                price = 50,
                itemtype = 45131,
                count = 1,
				movable = true,
                description = "-> Eternal Night Moon Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Demonia Backpack",
                price = 50,
                itemtype = 45154,
                count = 1,
				movable = true,
                description = "-> Demonia Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
		{
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Anniversary Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
		{
                icons = { "none.png" },
                ...
                count = 1,
				movable = true,
                description = "-> Voidwalker Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
		{
                icons = { "none.png" },
            ...
            },
		{
                ...
                itemtype = 45245,
                count = 1,
                description = "-> Ceremonial Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
				{
            ...
            },
		{
            ...
            },
			{
                ...
                itemtype = 44796,
                count = 1,
                description = "-> Pikachu Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Ornate Backpack",
                price = 50,
                itemtype = 44797,
                count = 1,
                description = "-> Ornate Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                ...
                itemtype = 44799,
                count = 1,
                description = "-> Majinboo Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Celestial Backpack",
                price = 50,
                itemtype = 44800,
                count = 1,
                description = "-> Celestial Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                ...
                itemtype = 44801,
                count = 1,
                description = "-> Cobra Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Deathstrike Backpack",
                price = 50,
                itemtype = 44802,
                count = 1,
                description = "-> Deathstrike Backpack.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Boneheart Backpack",
                price = 50,
                itemtype = 44804,
                count = 1,
                description = "-> Boneheart Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
            ...
            },
			{
                ...
                itemtype = 44870,
                count = 1,
                description = "-> Guildbank Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = { "none.png" },
                name = "Skeletin Backpack",
                price = 50,
                itemtype = 44871,
                count = 1,
                description = "-> Skeletin Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
            ...
            },
			{
                ...
                itemtype = 44890,
                count = 1,
                description = "-> Spiritthorn Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                ...
                itemtype = 44891,
                count = 1,
                description = "-> Arcanomancer Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
            ...
            },
			{
                ...
                itemtype = 44914,
                count = 1,
                description = "-> Halloween Backpack.",
				movable = true,
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
    ...
    {     
        ...
        offers = {
                              {
                   icons = { "none.png" },
                   name = "earth protection amulet",
           home = true,
                   price = 250,
                   itemtype = 44931,
                   count = 1,
                   movable = true,
                   description = "Receive a amulet that protect 10% of the element. Receive 4 additional skill and magic level.",
                   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
               },
               {
                icons = { "none.png" },
                name = "energy protection amulet",
        home = true,
                price = 250,
                itemtype = 44932,
                count = 1,
                movable = true,
                description = "Receive a amulet that protects 10% of the element. Receive 4 additional skill and magic level.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            {
                icons = { "none.png" },
                name = "fire protection amulet",
        home = true,
                price = 250,
                itemtype = 44933,
                count = 1,
        ...
        home = true,
            ...
            {
                icons = { "none.png" },
                name = "energy protection ring",
        home = true,
                price = 250,
                itemtype = 44937,
                count = 1,
                movable = true,
                description = "Receive a ring that protects 10% of the element. Receive 10% of critical damage and 2% of critical chance.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
            {
                icons = { "none.png" },
                name = "fire protection ring",
        home = true,
                price = 250,
                itemtype = 44938,
                count = 1,
