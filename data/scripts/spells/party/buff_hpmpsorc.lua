...
condition:setParameter(CONDITION_PARAM_HEALTHTICKS, 2000) -- a cada 2 segundos
condition:setParameter(CONDITION_PARAM_MANAGAIN, 20)
condition:setParameter(CONDITION_PARAM_MANATICKS, 2000) -- a cada 2 segundos
...
spell:name("Mana Life Regeneration")
spell:words("utevo gran mas sio")
spell:group("support")
