...
local potions = {
	...
	[45236] = { mana = { 625, 975 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 400, flask = 284, description = "Only druids and sorcerers of level 400 or above may drink this fluid." },
	[45235] = { health = { 1175, 1425 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 400, flask = 284, description = "Only knights of level 200 or above may drink this fluid." },
	[45237] = { health = { 620, 980 }, mana = { 350, 650 }, vocations = { VOCATION.BASE_ID.PALADIN }, level = 400, flask = 284, description = "Only paladins of level 130 or above may drink this fluid." },
