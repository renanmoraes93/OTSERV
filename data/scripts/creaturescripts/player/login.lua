...
function playerLoginGlobal.onLogin(player)
    ...
    -- Define o nível inicial de streak sempre que o jogador se conecta
    ...
    -- Boosted
    player:sendTextMessage(MESSAGE_BOOSTED_CREATURE, "Today's boosted creature: " .. Game.getBoostedCreature() .. " Boosted creatures yield more experience points, carry more loot than usual and respawn at a faster rate.")
    player:sendTextMessage(MESSAGE_BOOSTED_CREATURE, "Today's boosted boss: " .. Game.getBoostedBoss() .. " Boosted bosses contain more loot and count more kills for your Bosstiary.")
